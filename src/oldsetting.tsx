import { Button, Heading, Text, VStack, Modal, useColorMode } from "native-base";
  ...
  const SECTIONS = [
    ...
    
    {
      ...
      items: [
        ...
        { icon: 'moon', color: '#776CCB', label: 'Thème sombre', value: false, type: 'boolean'},
      ],
    },
    {
      header: 'Aide',
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (label == "Se deconnecter") {
                      ...
                      goToDeleteData()
                    } else if (label == "Thème sombre") {
                      //<Switch value={value} /> 
                      toggleColorMode();
                    } else if (label == "Langue") {
                      goToDeleteData()
                    }
                  }}>
