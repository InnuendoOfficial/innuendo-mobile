...
return (
    ...
    <VStack space={4} alignItems="center">
        ...
        <Text textAlign="center">Veuillez entrer la nouvelle adresse e-mail que vous souhaitez associer à votre compte et ensuite cliquez sur le bouton confirmer.</Text>
        <FeatherIcon
            color="#776CCB"
            name="mail"
            style={{
...
<FormControl isRequired >
        ...
        <Button rounded="lg" size="lg" w="100%"  fontWeight="bold" onPress={handleSubmit(sendNewEmail)} isLoading={isLoading}>
            <Text bold style={{ color: 'white', fontSize: 15 }}>Mettre à jour l'addresse e-mail</Text>
        </Button>
    </VStack>
</ScreenView>
