    ...
    <ScreenView style={{ justifyContent: "space-between" }}>
      ...
      >
        ...
        {isLoading ? (
          ...
          <Heading textAlign="center">Aucun endoscore pour le moment</Heading>
        ) : (
          <>
            <Heading fontSize="6xl">{endoscore.score} / 10</Heading>
            ...
            >
              <VStack space={1}>
                ...
                <Text fontSize="md" color="coolGray.800">
                  Il est recommandé de consulter un professionnel en lui
                  montrant ce score
                </Text>
              </VStack>
            </Alert>
