...
const isCompleted = (report: Report, reportField: keyof Symptoms): boolean =>
  JSON.stringify(report.symptoms[reportField]) !==
    ...
    symptoms: [
      {
        ...
        display: (report) =>
          `Douleurs : ${report.symptoms.urinaryDisorders.pain} / 10`,
      },
      {
        reportKey: "burn",
        input: {
    ...
    symptoms: [
      {
        ...
        display: (report) =>
          `Douleurs : ${report.symptoms.digestiveDisorders.pain} / 10`,
      },
      {
